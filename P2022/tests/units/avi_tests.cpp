...
TEST_CASE("default")
{
    SECTION("trivial", "test with default projections and compare function")
    {
...
TEST_CASE("custom compare")
{
    SECTION("custom compare func", "test with custom compare function")
    {
...
TEST_CASE("unordered #2", "[unordered]")
{
    SECTION("std::partial_ordering::unordered", "test with custom compare function which returns std::partial_ordering::unordered")
    {
    // generating two lists, l1 and l2, where until the kth index they are identical and after it
...
TEST_CASE("all custom")
{
    SECTION("custom projs, comp", "test with custom projections and custom compare function")
    {
        // generating two lists, l1 and l2, where the elements of l2 are twice as big
        // as the elements in l1
        // with two different projections
